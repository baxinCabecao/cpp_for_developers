...
int main()
{
    ...
    if (x > 3) {  // 'if' is a conditional statement. The condition inside '()' is evaluated.
        // If the condition is true, the code inside the following '{}' is executed.
        cout << "x is greater than 3" << endl;
    }

    for (int i = 0; i < 3; i++) {  // A 'for' loop. It has three parts: initialization, condition, and iteration.
